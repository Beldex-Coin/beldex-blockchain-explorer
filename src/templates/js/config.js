var config = {
    ...
    coinUnitPlaces: 9,
    txMinConfirms: 10,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in Beldex
    txCoinbaseMinConfirms: 60, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in Beldex
    coinSymbol: 'BDX',
    openAliasPrefix: "bdx",
    coinName: 'Beldex',
    coinUriPrefix: 'bdx:',
